...
public class ArbolBB {
    ...
    public void insertar(Nodo nuevo, Nodo nuevo2) {
        if (this.raiz == null) {
            raiz = nuevo;
        } else {
            if (nuevo.getDato() <= nuevo2.getDato()) {
                if (nuevo2.getIzq() == null) {
                    nuevo2.setIzq(nuevo);
                } else {
                    insertar(nuevo, nuevo2.getIzq());
                }
            } else {
                if (nuevo2.getDer() == null) {
                    nuevo2.setDer(nuevo);
                } else {
                    insertar(nuevo, nuevo2.getDer());
                }
            }
        }
